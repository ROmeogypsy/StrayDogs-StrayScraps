...
def find_character_file(char_name: str, chars_dir: Path = CHARS_DIR) -> Optional[Path]:
    ...
    if not chars_dir.exists():
        # print(f"{Colors.YELLOW}Warning: Characters directory not found: {chars_dir}{Colors.RESET}")
        return None
